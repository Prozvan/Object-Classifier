...
class GUI:
    ...
    def Components(self):
        ...
        def Get_Asset(item): return "Visual/assets/" + item
        ...
        #BUTTONS
        self.BUTTON = PhotoImage(file=Get_Asset("button_1.png"))
        BUTTON_SIZE_W = 135.0
        BUTTON_SIZE_H = 65.0 
        SIZE = 14
        ...
        self.entry_image = PhotoImage(file=Get_Asset("entry_1.png"))
    ...
    def Replace_Object_Name(self, bin):
        ...
        if "Epochs" == value[0]:
            ...
            print(f"Name change -> {objec} - {name}")
    ...
    def Button_Click(self, key):  #Buttons
        ...
        self.samples = self.APP.Button_Click(key, self.picture)
    ...
    def Pressed_Key(self, key):  #KEYS F1 F2
        ...
        if key != self.beforeKey:  #Nič tiščanja
            ...
            self.samples = self.APP.Key_Pressed(key, self.picture)
            self.numSamples.configure(text = self.samples)
    ...
    def Prediction(self, option):
        ...
        if self.TrainingStatus:  #Has to be trained
            ...
            if option: #Auto Predict
                ...
                else: self.autoON = True   #Start Auto Predict
    ...
    def Load(self):
        ...
        if DIR != "":
            ...
            print(1)
            samples, object_1, object_2, Model_Choice = self.APP.Return_Load_Parameters()
            ...
            if samples is not None:
                ...
                if Model_Choice != 0:
                    self.isAlgorithmSelected = True
                    print(self.TrainingStatus, "Training Status")
                ...
                if Model_Choice == 1: self.btn_KNc.select()
                elif Model_Choice == 2: self.btn_NN.select()
                elif Model_Choice == 3: self.btn_LSVC.select()
                elif Model_Choice == 0:
                ...
                self.beforeChoice = Model_Choice
